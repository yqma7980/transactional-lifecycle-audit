...
class SeededVersionMismatch(SafeLocal):
    """Metadata-only negative control; element assembly injects the mismatch."""

    name = "seeded_version_mismatch"

    @property
    def operator_version(self) -> str:
        return "L1-MP-1.0:seeded_version_mismatch"
...
VARIANTS = {
    ...
    "seeded_version_mismatch": SeededVersionMismatch,
}
